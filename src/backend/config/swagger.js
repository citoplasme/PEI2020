...
swaggerDoc.servers[0].variables.version.default = dataBases.apiVersion
swaggerDoc.servers[0].variables.version.enum[0] = dataBases.apiVersion
swaggerDoc.servers[0].variables.domain.default = dataBases.swaggerURL
swaggerDoc.servers[0].variables.domain.enum[0] = dataBases.swaggerURL
//Escrever o ficheiro final da especificação OpenAPI
fs.writeFileSync("./public/docs.yaml", yaml.dump(swaggerDoc))
