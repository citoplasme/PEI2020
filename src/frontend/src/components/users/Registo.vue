    ...
    <v-dialog :value="tos_modal" persistent>
      <v-card>
        ...
        <v-card-text style="text-align: justify; text-justify: inter-word;">
          ...
          who enjoy the platform, so it should be read carefully.<br/> The use of the
          ...
          not allowed.<br/> The last amendment to these Terms of Use dates from
          22.12.2020.<br/><br/> <b>Table of Contents:</b><br/><ol> <li>Definitions and General Conditions</li>
          <li>Privacy Policy</li><li>Guarantees</li><li>Rights and Obligations</li><li> Responsibility</li><li>Conflicts</li><li>Penalties</li><li>Payments</li><li>Transitional
          and Final Provisions</li> </ol><b>1. Definitions and General Conditions</b><br/><br/><b>a)
          Definitions</b><ul><li><b>"Servicify"</b> - website of the trademark "Servicify", owned
          by the company Servicify, Lda. </li><li><b>"Final Clients" </b>- those who use
          Servicify's website to place orders for the provision of certain
          services by professionals registered for that purpose. </li><li><b>"End Customer
          Information" </b>- any information provided by the End Customer, either
          ...
          from the use of the website. </li><li><b>"Privacy Policy"</b> - description of the
          types of information collected from End Users or Customers and the
          Service Provider and how it is handled. </li><li><b>"Request"</b> - description made
          ...
          purpose.</li><li> <b>"System" </b>- computer equipment, storage and transmission of
          ...
          Servicify. </li><li><b>"Terms and Conditions"</b> - are the rules that are binding on
          ...
          </li><li><b>"Professional"</b> - natural or legal persons, service providers,
          ...
          those services. </li><li><b>"User"</b> - any natural or legal person who accesses the
          website until the moment they acquire the status of End Customer or
          Service Provider. </li><li><b>"Website" (of Servicify)</b> - website and its domain,
          ...
          Servicify.</li></ul><b> b) General Conditions </b><ol><li> Servicify's website is an online
          platform where End-Customers request a certain service from Service
          Providers, who can then enter a biding process with the customer</li><li>
          Requests submitted by End Clients are disclosed to registered Service
          Providers whose activity is compatible with them. </li><li> It is up to the
          ...
          and exclusive responsibility.</li><li> Servicify is limited, in its
          ...
          to them in order to allow the process of choosing the End Client.</li><li>
          ...
          them. </li><li> The information regarding orders and Professionals that
          appears on the website is provided, respectively, by End Clients and
          Professionals.</li><li> Servicify does not select specific Professionals;
          </li><li> End Clients and Professionals are obliged to include only true and
          correct information on the website. </li><li> is not responsible
          ...
          and prove the truthfulness, accuracy and integrity of the same. </li><li>
          ...
          them. </li></ol> <b>c) Privacy Policy</b> <br/><br/>The company Servicify, Ltd, the entity
          ...
          recorded by users. <br/><br/>This Privacy Statement is intended to ensure
          ...
          their data, rectify them or delete them.<br/><br/> We assume the following
          commitments towards the Users:<ul><li>To process data in a lawful and fair
          manner, collecting only the necessary information relevant to the
          purpose for which they are intended;</li><li>To allow the holder of the data
          to access and correct the information about them registered;</li><li>Not to
          use the data collected for a purpose incompatible with that of
          collection; </li><li> To keep the data accurate and, if necessary, current; </li><li>
          To guarantee free of charge the right to delete the data used when
          requested by the owner; </li><li> To possess security mechanisms that prevent
          the consultation, modification, destruction or addition of the data by
          a person not authorized to do so; </li><li> Not to interconnect personal data,
          unless authorized by law. </li></ul><b>d) Collection of Personal Data</b> <br/><br/>The site
          ...
          security rules.<br/><br/> The user when registering at
          ...
          associated partners.<br/> When you interact with our Platform or use our
          Services, we automatically collect the following data:<ol><li><b>User Login
          Data</b> We store technical details such as your IP (Internet Protocol),
          ...
          successful login.</li><li><b> Click Sequence Data</b> We collect information about
          ...
          content of the platform. </li><li><b> Cookies and Similar Technologies</b>
          ...
          publicly available sources:</li></ol> We receive personal data about you from
          the following third parties (and public services): <ul><li> Technical data
          providers and usability data analyzers: Google, Facebook, Optimizely
          and Hotjar; </li><li> Navigation and conversion data from advertising
          providers: Google, Facebook</li></ul> www.servicify.di.uminho.pt uses the
          ...
          visited https://www.servicify.di.uminho.pt/.<br/><br/> Users can opt out of
          ...
          Analytics Opt-out Browser Add-on.<br/><br/> www.servicify.di.uminho.pt uses
          ...
          content network. <br/><br/>Third parties such as Google may display ads from
          www.servicify.di.uminho.pt on sites within their content network.
          <br/><br/>Third parties, such as Google, may use Cookies (such as Google
          Analytics and DoubleClick cookies) which serve to optimize ads based
          on information from past visits of users to
          www.servicify.di.uminho.pt.<br/><br/> <b>e) User Registration</b> <br/><br/>The user registration
          ...
          exclusive access to the management of the services.<br/><br/>The data provided
          ...
          <br/><br/> Access to www.servicify.di.uminho.pt is conditioned by a
          ...
          <br/><br/>Recommendation: A good password should include letters, numbers and
          special characters and should not be a common or easily detectable
          word. <br/><br/>The password is personal and non-transferable. The user's use of
          it is his/her own responsibility.<br/><br/> <b>f) Other Services</b><br/><br/> Other services that
          ...
          Security and Quality of Information <br/><br/>It is our goal to guarantee the
          ...
          to keep the information secure, accurate, updated and complete.<br/><br/> To
          ...
          encrypted. Sharing personal information<br/><br/> The personal information
          collected at https://www.servicify.di.uminho.pt/ is used for the
          purposes indicated in each case.<br/><br/><b>g) Links</b><br/><br/> www.servicify.di.uminho.pt
          contains links to other websites, and the website is not responsible
          for the privacy policies or content of such websites.<br/><br/><b>h) Statistical Log</b><br/><br/>
          ...
          established with the services and interactions with users.<br/><br/> The
          ...
          or private information. <br/><br/>The analyses carried out from the aggregated
          ...
          from the analyses made may be disclosed to third parties or publicly.<br/><br/>
          Should www.servicify.di.uminho.pt change its privacy practices, these
          will always be available at this site.<br/><br/> For further information, please
          contact support-pt@Servicify.com.<br/><br/> <b>Conditions of Use</b><br/><br/>
          ...
          Conditions of Use. <br/><br/>If you have any questions, complaints or comments
          regarding our privacy statement or policy, please contact us at
          support-pt@Servicify.com. <br/><br/><ol><li><b> Warranties</b><ol><li>Servicify guarantees the
          ...
          cannot be demanded.</li><li>Without prejudice to the above, Servicify
          ...
          users. </li><li> Final and Professional Clients are obliged, in the
          ...
          references to other sites, of whatever nature. </li><li> Final Clients and
          ...
          computer. </li><li> Final and Professional Clients are also prevented from
          ...
          nature, including personal data. </li><li> Servicify is not responsible for
          any error, omission, inaccuracy or falsity of information transmitted
          by Final Clients and Professionals. </li><li> Servicify reserves the right
          not to use, in any way, any information that violates this Terms of
          Use Agreement. </li></ol></li><li><b> Rights and Obligations</b><ol><li>Adherence as an End
          ...
          rights and obligations for each of the parties, namely: </li><li> The End
          ...
          to the corresponding privacy policy. </li><li>Servicify has the
          ...
          </li><li>The End Clients are obliged not to submit orders not admitted by
          law or by the terms of this Terms of Use Agreement. </li><li>Final
          Clients are solely responsible for the content and accuracy of any
          information provided. </li><li>Final Clients and Professionals undertake
          ...
          </li><li>Final Clients and Professionals agree not to use the Servicify
          ...
          </li><li> Professionals are obliged to provide the services and perform
          ...
          regulations that frame them.</li></ol></li><li><b>Responsibility</b><ol><li> Servicify is not a
          ...
          fulfilment of the contract and the parties' contractual duties. </li><li>
          ...
          may result for either party. </li></ol></li><li><b>Conflicts</b><ol><li> Conflicts arising from
          the relationships established between End Clients and Professionals
          must be reported to Servicify.</li><li>The information gathered as a
          ...
          website.</li></ol></li><li><b>  Penalties</b> <ol><li> Servicify has the right to clarify and
          ...
          </li><li>The use of the website may be suspended for a certain period
          ...
          been violated. </li><li> End Clients and Professionals may be permanently
          ...
          terms of the behaviour, the means used or the damage caused.</li><li>
          ...
          the provisions of this Terms of Use Agreement or applicable law.</li></ol></li><li>
          <b>Payments</b><ol><li> Use of the website by End Customers and Service Providers
          is free of charge, the latter can activate 'Premium' in order to have
          better visibility. </li></ol></li><li><b>Transitional and Final Provisions</b><ol><li> In the
          ...
          remainder.</li><li> The implicit or explicit violation of any provision of
          this Agreement by an End Customer or Professional shall result in
          immediate termination of access to the Website. </li><li> This Terms of Use
          ...
          agreements concerning the same content. </li><li> Any communication made in
          ...
          contained in the website and information collected from users.</li><li> Any
          ...
          maintained. </li><li> Nothing contained in this Agreement constitutes or is
